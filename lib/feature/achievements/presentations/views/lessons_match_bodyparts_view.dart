...
class LessonsMatchBodyPartsView extends StatefulWidget {
  ...
  const LessonsMatchBodyPartsView({super.key,
  ...
  @override State<LessonsMatchBodyPartsView> createState() => _LessonsMatchBodyPartsViewState();
}

class _LessonsMatchBodyPartsViewState extends State<LessonsMatchBodyPartsView> with TickerProviderStateMixin {
  final List<_Q> _questions = const [
    _Q('assets/images/eye.png','eye'), _Q('assets/images/arm.png','arm'), _Q('assets/images/nose.png','nose'),
  ];
  final List<_O> _options = const [
    _O('assets/images/armtext.png','arm'), _O('assets/images/eyetext.png','eye'), _O('assets/images/nosetext.png','nose'),
  ];
    ...
    body: SafeArea(child: Padding(
      ...
      child: Column(crossAxisAlignment:CrossAxisAlignment.start, children:[
        Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,
          ...
          children:[
            const Text('Match the body parts\nwith the words',
        ...
        const Text('Select the words that match in the pictures.',style:TextStyle(fontSize:16,color:Colors.grey)),
